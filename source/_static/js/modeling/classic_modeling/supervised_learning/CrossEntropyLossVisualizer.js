...
var CrossEntropyLossVisualizer = function CrossEntropyLossVisualizer() {
...
/* export removed */ /* CrossEntropyLossVisualizer will be assigned to window.CrossEntropyLossVisualizer */
// Global export
if (typeof window !== 'undefined') {
  window.CrossEntropyLossVisualizer = CrossEntropyLossVisualizer;
}


    // Make sure the component is exported to the global window object
    if (typeof window !== 'undefined' && typeof CrossEntropyLossVisualizer !== 'undefined') {
        window.CrossEntropyLossVisualizer = CrossEntropyLossVisualizer;
        console.log('Successfully exported CrossEntropyLossVisualizer to global scope');
    }
})();
